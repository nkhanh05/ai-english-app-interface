  ...
  Future<void> _saveWordToLibrary() async {
    ...
    try {
      ...
      await Future.wait([
        ...
        // Mình đổi 1 cái thành updateTotalExp, nếu bạn chủ đích gọi 2 lần Weekly thì cứ đổi lại nhé
        StudentService.updateTotalExp(userId, 20),
        StudentService.updateWeeklyExp(userId, 20),

        MissionService.updateWordMissionProgress(userId),
        BadgeService.checkAndAwardBadges(userId),
        MissionService.updateFriendMissionProgress(userId),
      ]);

      debugPrint("✅ Đã chạy xong toàn bộ API cập nhật cùng lúc!");
